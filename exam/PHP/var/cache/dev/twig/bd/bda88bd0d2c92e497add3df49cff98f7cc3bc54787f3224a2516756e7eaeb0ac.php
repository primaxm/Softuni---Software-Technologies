...
{% block panel %}
        ...
        <table>
            <thead class=\"small\">
                <tr>
                    ...
                    <th>Security issue {{ collector.symfonystate == 'eol' ? 'were' : 'are' }} fixed until</th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "D:\\exam\\PHP\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\config.html.twig");
    }
}
